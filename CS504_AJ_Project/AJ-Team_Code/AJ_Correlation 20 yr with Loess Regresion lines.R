...
########################  
# Correlation with Loess Regression Lines Quits Data
...
ggp2 = ggpairs(QI2,columns = 1:11, title = "                                                                                                        Quits by Industy 2001-2021
                                                                                 Correlation Plots with Loess Regresion and Smoothing", lower = list(continuous = ggpair_fn))
ggp2 
ggp2a = ggpairs(QI2,c(3,4,8,9),title = "                                                                                                        Quits by Industy 2001-2021
                                                                                 Correlation Plots with Loess Regresion and Smoothing", lower = list(continuous = ggpair_fn))
