...
QI <- read.csv(file="QuitsIndustry_2016-2021q.csv", header = TRUE, 
               sep=',', row.names =1)
data <- QI
ggpairs(QI)
head(QI)
...
ggp1 = ggpairs(QI,columns = 1:11, lower = list(continuous = ggpair_fn))
ggp1
ggp2 = ggpairs(QI,c(3,4,8,9), lower = list(continuous = ggpair_fn))
ggp2
